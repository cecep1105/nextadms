...
export default function PortalProfilePage() {
  ...
  useEffect(() => {
    // HARUS tunggu accessToken tersedia dulu -- fetch sebelum session
    // NextAuth selesai load bikin request kekirim TANPA Authorization
    // header (401). Lihat catatan lengkap di lib/use-device-function-choices.ts.
      ...
      <PageHeader
        ...
        action={
          <Button variant="outline" size="sm" asChild>
            <Link href="/portal/profile/password"><KeyRound className="h-3.5 w-3.5" /> Ganti Password</Link>
          </Button>
        }
      />
