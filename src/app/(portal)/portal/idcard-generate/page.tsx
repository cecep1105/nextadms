...
/**
 * Versi PORTAL dari halaman Generate Kartu staff (idcard/generate) --
 * LOGIC & UI SAMA PERSIS, cuma path navigasi disesuaikan ke rute portal
 * & ada link "Kembali ke Menu" (pola standar semua halaman portal).
 * Endpoint backend yang dipanggil SAMA (permission-nya SUDAH diperluas
 * terima izin portal can_view_idcard, lihat idcard/api_views.py).
 */
export default function PortalGenerateIdCardPage() {
            ...
            <div className="space-y-1.5">
              ...
              {holders.length === 0 && (
                <p className="text-xs text-muted-foreground">
                  ...
                  <a href="/portal/idcard-holders" className="text-primary hover:underline">Data Visitor/BHL</a>.
                </p>
              )}
              {selectedHolder && (
                <div className="flex items-center gap-2 rounded-md border border-success/30 bg-success/10 px-3 py-2 text-xs">
