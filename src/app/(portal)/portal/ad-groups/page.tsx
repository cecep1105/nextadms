...
// (AddAdGroupDialog) & kelola keanggotaan (ManageMembersButton) SENGAJA
// dikecualikan dari cakupan izin portal can_view_ad_groups (lihat
// netmgmt/active_directory_view.py::ADGroupCreateView/ADGroupMembershipView,
// permission-nya TETAP staff-only).
...
export default async function PortalAdGroupsPage({
  searchParams,
}: {
  ...
  const data = await getAdGroups(searchParams.sortBy, searchParams.sortDir, searchParams.page, searchParams.q, searchParams.page_size);
