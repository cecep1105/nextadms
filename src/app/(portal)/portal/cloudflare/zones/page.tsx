...
export default async function PortalCloudflareZonesPage({
  searchParams,
}: {
  ...
  const data = await getZones(searchParams.sortBy, searchParams.sortDir, searchParams.page, searchParams.q, searchParams.page_size);
                ...
                <TableRow key={zone.id}>
                  ...
                  <TableCell>
                    <div className="flex justify-end">
                      <Link
                        href={`/portal/cloudflare/zones/${zone.id}`}
