...
export default async function IdCardDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          <Link href="/idcard/cards" className="inline-flex items-center gap-1 text-primary hover:underline">
